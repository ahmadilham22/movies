  ...
  <body class="bg-stream-dark">
    ...
    <div class="grid md:grid-cols-12 font-poppins relative pb-20">
      ...
      <span class="fixed -z-10 top-0">
        <img
          src="{{ asset('stream/assets/images/pricing_ornament.svg')}}"
        ...
        <div class="px-5 lg:px-[60px] pt-[30px] relative">
          ...
          {{-- <div class="flex flex-row justify-between items-center relative">
            ...
            <div class="collapsible-dropdown flex flex-col gap-2 relative">
              ...
              >
                <img
                  src="{{ asset('stream/assets/images/photo.png')}}"
          ...
          <div class="pt-[85px] flex flex-col items-center gap-5">
            <p class="text-sky-300 text-base font-semibold">START TODAY</p>
            <div
              class="font-bold text-white text-4xl lg:text-[45px] text-center capitalize leading-snug"
            >
              Up Your Imagination
            </div>
            ...
            <div class="mt-[70px] flex justify-center gap-[40px] flex-wrap">
              ...
              <div class="pricing-card">
                <p class="text-stream-dark font-medium text-base">{{ ucwords($standard->name) }}</p>
                <div class="text-3xl text-stream-dark font-semibold my-1">
                  Rp {{ number_format($standard->price) }}
                </div>
                <p class="text-sm text-stream-gray">/bulan</p>
                <hr class="my-[30px]" />
                ...
                <div class="flex flex-col gap-6">
                  ...
                  <div class="flex items-center justify-between gap-3">
                    <span class="li-benefits"> {{ $standard->max_users }} Users Limits </span>
                    <img src="{{ asset('stream/assets/images/ic_check.svg')}}" alt="stream" />
                  </div>
                  <!-- benefits -->
                  <div class="flex items-center justify-between gap-3">
                    <span class="li-benefits"> 720 & 1080 full HD </span>
                    <img src="{{ asset('stream/assets/images/ic_check.svg')}}" alt="stream" />
                  </div>
                  <!-- benefits -->
                  <div class="flex items-center justify-between gap-3">
                    <span class="li-benefits"> TV & Laptop Streaming </span>
                    <img src="{{ asset('stream/assets/images/ic_check.svg')}}" alt="stream" />
                  </div>
                  <!-- benefits -->
                  <div class="flex items-center justify-between gap-3">
                    <span class="li-benefits"> 180 Movies Available </span>
                    <img src="{{ asset('stream/assets/images/ic_check.svg')}}" alt="stream" />
                  </div>
                  <!-- benefits -->
                  <div class="flex items-center justify-between gap-3">
                    <span class="li-benefits"> 24 Origin Countries </span>
                    <img src="{{ asset('stream/assets/images/ic_check.svg')}}" alt="stream" />
                  </div>
                </div>
              ...
              <!-- Card -->
              <div class="pricing-card">
                <p class="text-stream-dark font-medium text-base">{{ ucwords($gold->name) }}</p>
                <div class="text-3xl text-stream-dark font-semibold my-1">
                ...
                <div class="flex flex-col gap-6">
                  <!-- benefits -->
                  <div class="flex items-center justify-between gap-3">
                    <span class="li-benefits"> {{ $gold->max_users }} Users Limits </span>
                    <img src="{{ asset('stream/assets/images/ic_check.svg')}}" alt="stream" />
                  </div>
                  <!-- benefits -->
                  <div class="flex items-center justify-between gap-3">
                    <span class="li-benefits"> Up to 8K Quality </span>
                    <img src="{{ asset('stream/assets/images/ic_check.svg')}}" alt="stream" />
                  </div>
                  <!-- benefits -->
                  <div class="flex items-center justify-between gap-3">
                    <span class="li-benefits"> All Platforms Streaming </span>
                    <img src="{{ asset('stream/assets/images/ic_check.svg')}}" alt="stream" />
                  </div>
                  <!-- benefits -->
                  <div class="flex items-center justify-between gap-3">
                    <span class="li-benefits"> 900+ Movies Available </span>
                    <img src="{{ asset('stream/assets/images/ic_check.svg')}}" alt="stream" />
                  </div>
                  <!-- benefits -->
                  <div class="flex items-center justify-between gap-3">
                    <span class="li-benefits"> 120 Origin Countries </span>
                    <img src="{{ asset('stream/assets/images/ic_check.svg')}}" alt="stream" />
                  </div>
                </div>
